...
<ol>
  ...
  <li><b>Approval of a New Editor in Case of Resignation or Removal from Position</b>: If an Editor vacates his/her position for any reason, the other Editor for that department will nominate a member of The Spectator staff to replace him/her. The Managing Board must approve this new Editor.</li>
  <li><b>Changeover Period</b>: Between the Fall and Spring semesters, the incoming Editors will replace the outgoing Editors. First, the incoming Editor-in-Chief and Managing Editor, chosen under Section III. A, will replace the outgoing holders of those positions for one issue. The rest of the incoming Editors will replace their outgoing counterparts in the next issue. It is the outgoing Editors&rsquo; responsibility to train those who are to take over their positions.</li>
  <li><b>Endorsements</b>: The Spectator may endorse candidates for the Student Union elections. After the primaries, the Managing Board interviews each candidate for the positions of Student Union President and Vice President, Senior Caucus, Junior Caucus, Sophomore Caucus and Freshman Caucus, and presents the results to the Editorial Board. The Editorial Board may then pick one set of candidates for each of these positions, print the candidates it endorses and explain its choices.</li>
  <li><b>Appellate Procedures</b>: Any person who wishes to appeal any action or decision of The Spectator should take his/her case to the Managing Board. The Managing Board deals with all appeals or objections to decisions or actions of The Spectator, except removal from position, in which all appeals should be made to the Faculty Advisor.</li>
  <li><b>Amendment of the Charter</b>: Amendment of the charter requires a two-thirds majority vote of the Editorial Board.</li>
</ol>
<h2>IV. Policies & Guidelines</h2>
<h3>A. Ethics</h3>
<ol>
  <li>As an agent of the free press, The Spectator will act in accordance with First Amendment principles.</li>
  <li>The Spectator will treat all people with respect and will not demean individuals on the basis of age, race, religion, gender, sexual orientation or mental/physical disabilities.</li>
  <li>The Spectator will explain to readers its journalistic processes when necessary and will be fair in its relations with all parties.</li>
  <li>Reporters can grant sources anonymity for matters that demand the public&rsquo;s right to know only as a last resort. Reporters should interview at least one other  anonymous source to confirm the validity of information obtained from them.</li>
  <li>Reporters must be clear with their sources about what is on the record and what is off the record. The Spectator will not publish information obtained off the record.</li>
  <li>The Spectator will strive to be accessible to its readers. The newspaper will be free for the Stuyvesant community, except in the case of subscriptions.</li>
</ol>
<h3>B. Content Policy</h3>
<ol>
  <li>The Spectator will report the news accurately, thoroughly and in an unbiased way, using honest methods to gather news. The Editors will hold factual information in opinion columns and editorials to the same standards of accuracy as news stories.</li>
  <li>The Spectator will hold itself responsible for all that is printed.</li>
  <li>The Spectator will not publish any material for which there is evidence that the author, on or off the staff, is using the paper to that writer&rsquo;s personal ends.</li>
  <li>The Spectator does not accept or publish everything it receives from interested contributors. The Editor-in-Chief and Managing Editor will determine when such materials will be printed.</li>
  <li>Any staffer may write commentary; that writer&rsquo;s byline indicates that the opinions expressed are the writer&rsquo;s own.</li>
  <li>Staff Editorials are unsigned and reflect the opinion of the Editorial Board.</li>
  <li>The Spectator will attempt to ascertain all possible story ideas for each issue, but it will select story ideas for coverage based on standard values of newsworthiness.</li>
  <li>No cartoons, art or photographs that editorialize may appear on News/Features pages.</li>
  <li>The Spectator constitutes plagiarism to be any instance in which a member of staff attempts to publish at least one full sentence of someone else&rsquo;s writing without proper citation as their own.</li>
  <li>If a staff member has been caught plagiarizing, he or she will be able to remain on The Spectator and will be given a warning, the content of which is up to the Department Editors&rsquo; discretion. If this person is caught plagiarizing again, he or she will be asked to leave The Spectator immediately.</li>
</ol>
<h3>C. Maintaining Independence</h3>
<ol>
  <li>The Spectator will remain free of outside interests, investments or business relationships that may compromise the credibility of its news reporting.</li>
  <li>No group outside The Spectator except the Faculty Advisor and those who advise the Editorial Board on issues of content and style under the agreement of confidentiality will review the newspaper prior to its release to the public. The Spectator will not tolerate any threats by the administration to withhold the newspaper from publication. In the case of these threats, the Editor-in-Chief and Managing Editor will approach the administration and settle the situation.</li>
  <li>We will not permit any source who demands to read the reporter&rsquo;s completed story before publication or perform editing tasks on the story to do so under any circumstances. However, the source may review the direct quotes used in the article to ensure that they are accurate.</li>
</ol>
<h3>D. Corrections Policy</h3>
<ol>
  <li>All factual errors, including misidentifications and misspellings of names and titles, must be corrected. The Corrections Box is a reflection of the integrity of the newspaper.</li>
  <li>It is recommended that the Corrections Box be placed on the Editorial page, along with the masthead, under a suitable heading.</li>
  <li>The Editors-in-Chief are responsible for corrections.</li>
  <li>If an article published on the website is corrected, the fact that it was updated must be clear to a reader.</li>
</ol>
<h3>E. Letters Policy</h3>
<ol>
  <li>The Spectator encourages Letters to the Editor so that readers may participate in a scholastic free press in an open forum.</li>
  <li>The Spectator will not print anonymous Letters to the Editor.</li>
  <li>The Editorial Board will choose letters for publication on the basis of timeliness and potential reader interest.</li>
  <li>The Spectator reserves the right to edit letters for length, appropriateness and grammatical correctness without altering meaning.</li>
</ol>
<h3>F. Independence from the Student Union</h3>
<ol>
  <li>Editors of The Spectator cannot run for or hold the positions of Student Union President or Vice President, Senior Caucus President or Vice President, Junior Caucus President or Vice President, Sophomore Caucus President or Vice President, or Freshman Caucus President or Vice President. Editors may not apply to hold or hold major Student Union positions or be members of the Student Union cabinet.</li>
  <li>Staff members of The Spectator may hold a position in the Student Union but may not be involved with newspaper content that involves the Student Union.</li>
</ol>
<h3>G. Conflicts of Interest</h3>
<ol>
  <li>Staffers must not write non-Opinions articles on their own teachers or on activities in which they are involved.</li>
  <li>A student who writes an article about a teacher he or she may have in the future does so at his/her own discretion. If a writer requests to be removed from a story for this reason, his/her Editor must honor that request.</li>
  <li>Editors and staff members must not be mentioned or quoted in articles or appear in photographs in which they have little importance.</li>
...
<ol>The Spectator will cover stories involving the death of current students, administration and alumni, including photographs, when possible, and relevant facts concerning the death.</ol>
<h3>J. Reporting on Crime</h3>
<ol>
  <li>If a student or faculty member is accused of a crime, The Spectator will report on it based on accepted professional protocol.</li>
  <li>The names of all accused individuals 18 years or older will be included in the story, regardless of whether that individual is a teacher, student, administrator, etc.</li>
  <li>The name of any student under 18 years old who is being tried as an adult in the court system will be included in the story.</li>
  <li>A student under 18 years old who is being tried as a minor will have his/her name omitted from the story.</li>
  <li>Should a student be subjected to disciplinary action by the administration of Stuyvesant High School, The Editorial Board will decide on a case-by-case basis whether to include that student&rsquo;s name.</li>
  <li>When possible, alleged victims of crimes that do not carry a stigma, such as robbery, will be interviewed and their names will be included.</li>
  <li>The names of victims of alleged crimes that carry a stigma, such as rape and sexual assault, will be withheld.</li>
  <li>Reporters will treat all individuals involved in criminal proceedings with sensitivity and compassion.</li>
</ol>
<h3>K. Advertisements Policy</h3>
<ol>
  <li>The Spectator reserves the right to turn away any advertisements at the discretion of the Business Managers.</li>
  <li>The Spectator does not necessarily endorse the advertisements that appear in its issues.</li>
  <li>The Spectator will be clear in differentiating advertisements from articles.</li>
